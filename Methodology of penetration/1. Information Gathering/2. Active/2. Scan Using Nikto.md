<h1>$${\color{blue}Nikto}\space {\color{blue}Tool }$$</h1>
...
```
nikto -h domain.com -T 5 -o test.html -Format htm
```

**-h**: or -Host for domain.
**-T**: or -Tuning for determine scan vulns.
**-o**: output save.
**-Format**: format of output save.

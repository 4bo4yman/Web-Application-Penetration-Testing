Welcome, my friend. Today we will start the [first access control lab](https://portswigger.net/web-security/access-control/lab-unprotected-admin-functionality) in ```portswigger```
